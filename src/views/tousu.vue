<template>
    <div>
        <div class="tousu">
                ...
                <input type="text" placeholder="" v-model="tousuForm.userId">
                	</FormItem>
                <FormItem label="手机号:" prop="mobile">
                    <input type="text" class="input" placeholder=""  v-model="tousuForm.mobile">
                </FormItem>
                <FormItem label="内容:" prop="content">
                    <input type="textarea" class="input" :autosize="{minRows: 2,maxRows: 5}" placeholder=""  v-model="tousuForm.content">
                </FormItem>
                <FormItem label="上传图片:">
                    <div>
